...
if run_setupmodel:    
    ...
    model = Model(modelname, path="../FORESEE/Models/DarkPhoton/")
...
if run_setupscans:
    ...
    setup_dict={
        ...
        "R1-L10-R1x3_effm1000":{
            #"name":"R1 L=10m X=3m Y=1m",
            "name":"New Baseline (X=3m Y=1m, Env=DV-1000mm)",
            #"color":"cornflowerblue",
            "color":"lightgreen",
            #"color":"limegreen",
            #"style":"dashed",
        ...
        "R1-L10-R1x3_effm500":{
            #"name":"R1 L=10m X=3m Y=1m",
            "name":"New Baseline (X=3m Y=1m, Env=DV-500mm)",
            #"color":"cornflowerblue",
            #"color":"lightgreen",
            "color":"limegreen",
            #"style":"dashed",
        ...
        "R1-L10-R1x3_effm250":{
            #"name":"R1 L=10m X=3m Y=1m",
            "name":"New Baseline (X=3m Y=1m, Env=DV-250mm)",
            #"color":"cornflowerblue",
            "color":"forestgreen",
            #"style":"dashed",
            "selection":"(np.sqrt(x.x**2)<1.5) * (np.sqrt(x.y**2)<0.5)",
...
#        "R1-L10-R1x3_effm100":{
#            #"name":"R1 L=10m X=3m Y=1m",
#            "name":"New Baseline (X=3m Y=1m, Env=DV-100mm)",
#            #"color":"cornflowerblue",
#            "color":"forestgreen",
#            #"color":"limegreen",
#            #"style":"dashed",
...
#        },
        "R1-L10-R1x3_eff0":{
            #"name":"R1 L=10m X=3m Y=1m",
            "name":"New Baseline (X=3m Y=1m, Env=DV)",
            #"color":"cornflowerblue",
            "color":"darkgreen",
            #"color":"limegreen",
            #"style":"dashed",
...
if run_runscans:
    ...
    for setup in setup_dict:
        ...
        outfile="Models/"+modelname+"/model/results/"+energy+"TeV_"+setup+".npy"
        ...
        for mass in masses:
            ...
            couplings, ctaus, nevents, momenta, weights = foresee.get_events(mass=mass, energy=energy, couplings=np.logspace(-8,-3,12),nsample=100 )
...
if run_plotreach:
    ...
    plot = foresee.plot_reach(
        ...
        eff_file="/Users/mcfayden/Work/FASER/FASER2/FASER_FORESEE/R1-L10-R1x3_DarkPhoton/eff_14TeV_FASER2_HepMC_v4_FASER2_Cavern_Rect_Baseline_Bhoriz_3rdTrkStation_envx.csv",                  
    )
    ...
    plot.savefig("Reach_DarkPhoton_F2CavernNewBaseline3rdStation_envx%s.pdf"%("_"+scan_name if scan_search else ""))
    #plot.show()
