...
if run_setupscans:
    ...
    setup_dict={
        ...
        "F2-default_eff0p1":{
            "name":"FASER2 Orig (Sep=0.1mm)",# (Default)",
            #"color":"maroon",
            "color":"darkorange",
            "selection":"np.sqrt(x.x**2 + x.y**2)< 1",
            "length":5,
        ...
        "F2-default_eff1":{
            "name":"FASER2 Orig (Sep=1mm)",# (Default)",
            #"color":"maroon",
            "color":"orange",
            "selection":"np.sqrt(x.x**2 + x.y**2)< 1",
            "length":5,
        ...
        "F2-default_eff10":{
            "name":"FASER2 Orig (Sep=10mm)",# (Default)",
            #"color":"maroon",
            "color":"peachpuff",
            "selection":"np.sqrt(x.x**2 + x.y**2)< 1",
            "length":5,
        ...
        "F2-default_eff100":{
            "name":"FASER2 Orig (Sep=100mm)",# (Default)",
            #"color":"maroon",
            "color":"gold",
            "selection":"np.sqrt(x.x**2 + x.y**2)< 1",
            "length":5,
...
if run_plotreach:
    ...
    plot.savefig("Reach_DarkPhoton_F2Default3rdStation_sep%s.pdf"%("_"+scan_name if scan_search else ""))
    #plot.show()
