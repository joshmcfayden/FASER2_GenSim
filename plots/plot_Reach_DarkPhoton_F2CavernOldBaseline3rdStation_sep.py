...
if run_plotreach:
    ...
    plot = foresee.plot_reach(
        ...
        eff_file="/Users/mcfayden/Work/FASER/FASER2/FASER_FORESEE/S2-L10-D2_DarkPhoton/eff_14TeV_FASER2_HepMC_v4_FASER2_Cavern_3rdTrkStation_sep.csv"
    )
    ...
    plot.savefig("Reach_DarkPhoton_F2CavernOldBaseline_sep%s.pdf"%("_"+scan_name if scan_search else ""))
    #plot.show()
