...
if run_setupscans:
    ...
    setup_dict={
        ...
        "R1-L10-R1x3_eff0p1":{
            #"name":"R1 L=10m X=3m Y=1m",
            "name":"New Baseline (X=3m Y=1m, Sep=0.1mm)",
            #"color":"cornflowerblue",
            "color":"green",
            #"color":"limegreen",
            #"style":"dashed",
        ...
        "R1-L10-R1x3_eff1":{
            #"name":"R1 L=10m X=3m Y=1m",
            "name":"New Baseline (X=3m Y=1m, Sep=1mm)",
            #"color":"cornflowerblue",
            "color":"forestgreen",
            #"color":"limegreen",
            #"style":"dashed",
        ...
        "R1-L10-R1x3_eff10":{
            #"name":"R1 L=10m X=3m Y=1m",
            "name":"New Baseline (X=3m Y=1m, Sep=10mm)",
            #"color":"cornflowerblue",
            "color":"limegreen",
            #"color":"limegreen",
            #"style":"dashed",
        ...
        "R1-L10-R1x3_eff100":{
            #"name":"R1 L=10m X=3m Y=1m",
            "name":"New Baseline (X=3m Y=1m, Sep=100mm)",
            #"color":"cornflowerblue",
            "color":"lightgreen",
            #"color":"limegreen",
            #"style":"dashed",
...
if run_plotreach:
    ...
    plot = foresee.plot_reach(
        ...
        eff_file="/Users/mcfayden/Work/FASER/FASER2/FASER_FORESEE/R1-L10-R1x3_DarkPhoton/eff_14TeV_FASER2_HepMC_v4_FASER2_Cavern_Rect_Baseline_Bhoriz_3rdTrkStation_sep.csv",                  
    )
    ...
    plot.savefig("Reach_DarkPhoton_F2CavernNewBaseline3rdStation_sep%s.pdf"%("_"+scan_name if scan_search else ""))
    #plot.show()
