...
plot = foresee.plot_reach(
    ...
    legendloc=(0.9,0.9),
    figsize=(8,6),
    eff_file='/Users/mcfayden/Work/FASER/FASER2/FASER_FORESEE/R1-L10-R1x3_DarkHiggs//eff_14TeV_FASER2_HepMC_v4_FASER2_Cavern_Rect_Baseline_Bhoriz_AllTrkStations_station3_env.csv'
)

plot.subplots_adjust(left=0.12, right=0.97, bottom=0.10, top=0.95)
plot.savefig("DarkHiggs_Pythia-Reach_F2CavernNewBaseline3rdStation_env%s.pdf"%("_"+scan_name if scan_search else ""))
