...
if run_plotreach:
    ...
    plot = foresee.plot_reach(
        ...
        eff_file="/Users/mcfayden/Work/FASER/FASER2/FASER_FORESEE/R1-L10-R1x3_DarkPhoton/eff_14TeV_FASER2_HepMC_v4_FASER2_Cavern_Rect_Baseline_Bhoriz_3rdTrkStation_env.csv",                  
    )
    ...
    plot.savefig("Reach_DarkPhoton_F2CavernNewBaseline3rdStation_env%s.pdf"%("_"+scan_name if scan_search else ""))
    #plot.show()
