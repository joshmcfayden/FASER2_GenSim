...
class Foresee(Utility):
    ...
    def plot_reach(self,
        ...
        for setup in setups:
            ...
            print("JOSH:",self.model.modelpath+"model/results/"+filename)
            print("JOSH: m:",len(m),"c:",len(c))
            print(m)
            print(c)
            #print("JOSH:",nsignals)
            #print("JOSH: len(nsignals):",len(nsignals),len(np.array(nsignals)))
            print("JOSH: len(nsignals):",len(nsignals),"len(nsignals[0]):",len(nsignals[0]))
            ...
            n = np.log10(np.array(nsignals).T+1e-20)
            #n = np.log10(nsignals)
            #n = np.apply_along_axis(np.log10,0,nsignals)
            #print("JOSH:",n)
            print("JOSH: len(n)",len(n))
